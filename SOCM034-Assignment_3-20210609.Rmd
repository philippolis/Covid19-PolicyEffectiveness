...
data <- data %>% filter(Date >= as.Date("2020-03-03")) %>% drop_na()
...
Indeed, the error-terms are not correlated, except for one case in Spain, where the autocorrelation of the error term at lag 4 is statistically significant with p >= 0.05. However, this should not come as a surprise when testing the autocorrelation for 64 lags in total and therefore should not be too concerning.
