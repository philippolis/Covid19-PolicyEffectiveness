...
subtitle: "A comparative time series-analysis of France, Germany, Italy and Spain"
author: "Philipp Holz"
date: "28 June 2021"
...
Two measures central to these studies that have frequently been used together are the policy stringeny index, which is part of the Oxford COVID-19 Government Response Tracker (OxCGRT) [@haleGlobalPanelDatabase2021], and the time-varying reproduction number. [compare @kohEstimatingImpactPhysical2020] 
...
```{r cor, fig.height=6, fig.width=6, appendix = TRUE}
...
First off, we can make a visual assessment of correlation between the time series and its lags. As we can see, there is strong correlation between e.g. the reproduction rate and its first lag, while already for the second lag this correlation is less strong.

```{r fig.height=6, fig.width=6, appendix = TRUE}
...
```{r diff, fig.height=6, fig.width=6, appendix = TRUE}
...
```{r fig.height=12, fig.width=6, appendix = TRUE}
...
```{r message=FALSE, warning=FALSE, fig.height=10, fig.width=6, appendix = TRUE}
