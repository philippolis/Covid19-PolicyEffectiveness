...
bibliography: SOCM034_references.bib
---
...
[@yoberoTimeSeriesRegression2017]
...
# Discussion
- fail to compute correct test statistics, we could do that using this and that method
- extend our analysis by including vaccination campaign as a covariate
